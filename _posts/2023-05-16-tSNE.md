...
![png](t-SNE_files/t-SNE_5_0.png)
    



### Manifold Learning(다양체 학습) : 훈련 데이터가 놓여져있는 다양체를 학습하는 방법
...
이 때, $p_{j|i} \neq p_{i|j}$이고 분산 $\sigma_{i}^{2}$이 각 {i}마다 다르다는것에 주의해야 한다. 이에 대해서 종종 $P_{ij} = \frac{1}{2N}(P_{j|i} + P_{i|j})$ 로 정의해 최종적인 분포가 symmetric이 되도록 해주는 경우도 있다.
...
![png](t-SNE_files/t-SNE_10_0.png)
...
$$
(단, K는 상수)가 된다. 이 때 이것의 ($y_{i}$에 대한)gradient는 정말 간단하게 표현이 된다.
...
![png](t-SNE_files/t-SNE_12_0.png)
...
![png](t-SNE_files/t-SNE_16_0.png)
...
![png](t-SNE_files/t-SNE_18_0.png)
...
![png](t-SNE_files/t-SNE_19_0.png)
...
![png](t-SNE_files/t-SNE_23_0.png)
...
![png](t-SNE_files/t-SNE_25_0.png)
...
![png](t-SNE_files/t-SNE_27_0.png)
...
![png](t-SNE_files/t-SNE_29_0.png)
...
![png](t-SNE_files/t-SNE_31_0.png)
...
![png](t-SNE_files/t-SNE_33_0.png)
...
![png](t-SNE_files/t-SNE_35_0.png)
...
![png](t-SNE_files/t-SNE_38_0.png)
